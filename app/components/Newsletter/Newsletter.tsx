...
const Newsletter = () => {
    return (
        <div className='mt-32 relative '>
            <div className="mx-auto w-3/5 bg-blue-500 rounded-3xl">
                <div className="">
                    ...
                    <div className="p-10 flex flex-col justify-center">
                        ...
                        <a className="flex justify-center underline mt-2 font-text-base font-extrabold mb-7 text-offwhite" href="mailto:support@noblkids.com">support@noblkids.com</a>
