    ...
    return (
        <div className="bg-darkblue -mt-40">
            <div className="mx-auto max-w-2xl pt-48 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                {/* <div className="my-5 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8"> */}
                    ...
                    <div className='flex items-center align-center justify-center space-x-10 mb-5'>
                        <div className="flex gap-2">
                            ...
                            <h5 className="text-base font-normal text-offwhite">Toronto, ON</h5>
                        </div>
                        ...
                        <div className="flex gap-2">
                            ...
                            <h5 className="text-base font-normal text-offwhite">support@noblkids.com</h5>
                        </div>
                    </div>
                ...
                <div className='py-10 lg:flex items-center justify-between border-t border-t-bordertop'>
                    <h4 className='flex justify-center text-offwhite text-sm text-center lg:text-start font-normal'>@2023 NOBL. All Rights Reserved</h4>
